      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-8 relative z-10">
        ...
        <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-3">
            <h2 className="text-lg font-bold text-foreground">1. Account Registration & Use</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-lg font-bold text-foreground">2. Meta API & WhatsApp Policies</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-lg font-bold text-foreground">3. Fees & Subscription Billing</h2>
            <p>
