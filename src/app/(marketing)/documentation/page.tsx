  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row gap-8 relative z-10">
        ...
        <aside className="w-full md:w-64 shrink-0 space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm bg-card border border-background rounded-xl focus:outline-none focus:border-blue-500 text-foreground placeholder:text-muted-foreground"
            />
          </div>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          activeArticle === item.id
                            ...
                            : "text-slate-455 hover:text-foreground hover:bg-card/60"
                        )}
                      >
                        {item.label}
        ...
        {/* Main Content Area */}
        <main className="flex-1 border border-card bg-card/10 rounded-2xl p-6 sm:p-10 backdrop-blur-sm text-left max-w-3xl">
          {activeArticle === "intro" && (
            <article className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-3xl font-extrabold text-foreground tracking-tight">Introduction to MJChatSyncs</h1>
              </div>
              ...
              <div className="border-t border-card pt-6">
                <h2 className="text-lg font-bold text-foreground mb-4">Core Platform Pillars</h2>
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl border border-card bg-muted/50 space-y-2">
                    <h3 className="text-xs font-bold text-blue-400 uppercase">1. Shared Team Inbox</h3>
                    <p className="text-[11px] text-muted-foreground leading-normal">Multiple agents managing customer conversations from a single WhatsApp number with automated routing.</p>
                  </div>
                  <div className="p-4 rounded-xl border border-card bg-muted/50 space-y-2">
                    <h3 className="text-xs font-bold text-blue-400 uppercase">2. Visual Workflows</h3>
                    <p className="text-[11px] text-muted-foreground leading-normal">Drag-and-drop conversational flow builder and scheduled drip marketing campaigns without writing code.</p>
                  </div>
                  <div className="p-4 rounded-xl border border-card bg-muted/50 space-y-2">
                    <h3 className="text-xs font-bold text-blue-400 uppercase">3. Knowledge-Base AI</h3>
                    <p className="text-[11px] text-muted-foreground leading-normal">Upload your product catalogs, refund policy PDFs, or FAQs and let your custom RAG AI resolve support queries.</p>
                  </div>
                  <div className="p-4 rounded-xl border border-card bg-muted/50 space-y-2">
                    <h3 className="text-xs font-bold text-blue-400 uppercase">4. Developer First</h3>
                    <p className="text-[11px] text-muted-foreground leading-normal">Robust REST APIs, secure incoming/outgoing webhooks, and native Model Context Protocol (MCP) support.</p>
                  </div>
                </div>
              </div>
            </article>
          ...
          {activeArticle === "onboarding" && (
            <article className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-3xl font-extrabold text-foreground tracking-tight">Quick Start Guide</h1>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="space-y-4 pt-4">
                <div className="space-y-2">
                  <h3 className="text-sm font-bold text-foreground">Step 1: Obtain Meta API Credentials</h3>
                ...
                <div className="space-y-2">
                  <h3 className="text-sm font-bold text-foreground">Step 2: Save Credentials in MJChatSyncs</h3>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                <div className="space-y-2">
                  <h3 className="text-sm font-bold text-foreground">Step 3: Send a Test Message</h3>
                  <p className="text-xs text-muted-foreground leading-relaxed">
          ...
          {activeArticle === "self-hosting" && (
            <article className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-3xl font-extrabold text-foreground tracking-tight">Self-Hosting with Docker</h1>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="space-y-2">
                <h3 className="text-sm font-bold text-foreground">Docker Compose Example</h3>
                <pre className="bg-background p-4 rounded-xl text-xs font-mono border border-card text-foreground overflow-x-auto leading-relaxed">
{`version: '3.8'
services:
  mjchatsyncs:
      ...
      - ENCRYPTION_KEY=your-64-hex-key`}
          ...
          {activeArticle !== "intro" && activeArticle !== "onboarding" && activeArticle !== "self-hosting" && (
            <div className="py-20 text-center space-y-3">
              <Bot className="h-12 w-12 text-muted-foreground mx-auto animate-bounce" />
              <h3 className="text-base font-bold text-foreground">Article Content Coming Soon</h3>
