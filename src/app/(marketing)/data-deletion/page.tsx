  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans relative overflow-hidden text-left">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-8 relative z-10">
        <div className="space-y-2 border-b border-card pb-6">
          <h1 className="text-3xl font-extrabold text-foreground tracking-tight">Data Deletion Policy</h1>
          <p className="text-xs text-muted-foreground">Last updated: June 28, 2026</p>
        </div>
        ...
        <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-3">
            <h2 className="text-lg font-bold text-foreground">What Data is Deleted?</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="text-lg font-bold text-foreground">How to Submit a Request</h2>
            <p>
            ...
            <div className="space-y-3 pl-4 pt-2">
              <div>
                <h4 className="text-xs font-bold text-foreground">Method 1: In-App Settings (Recommended)</h4>
              ...
              <div>
                <h4 className="text-xs font-bold text-foreground">Method 2: Email Request</h4>
                <p className="text-xs text-muted-foreground leading-relaxed">
