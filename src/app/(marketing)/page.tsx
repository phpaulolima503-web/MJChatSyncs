...
export default function HomePage() {
  ...
  return (
    <div className="space-y-24 pb-20 overflow-x-hidden bg-background text-foreground selection:bg-blue-500/30 selection:text-foreground">
      ...
      <section className="relative pt-12 md:pt-20 lg:pt-28 flex flex-col items-center text-center px-4 max-w-5xl mx-auto">
        ...
        {/* Hero Title */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-foreground max-w-4xl leading-[1.1]">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          <Link
            href="/book-demo"
            className="w-full sm:w-auto text-center font-semibold text-foreground bg-blue-600 hover:bg-blue-500 px-8 py-4 rounded-xl shadow-[0_0_25px_rgba(37,99,235,0.35)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] transition-all flex items-center justify-center gap-2 group"
          >
          ...
          <a
            href="#features"
            className="w-full sm:w-auto text-center font-medium text-foreground hover:text-foreground px-8 py-4 rounded-xl border border-border hover:border-border hover:bg-card/60 transition-all"
          >
            See How It Works
          </a>
        </div>
        ...
        <div className="mt-16 w-full rounded-2xl border border-card bg-card/10 p-2 shadow-2xl relative group">
          ...
          <div className="rounded-xl border border-border/80 bg-[#070a13] aspect-[16/10] overflow-hidden flex flex-col text-left select-none">
            {/* Window bar */}
            <div className="h-10 border-b border-card/80 flex items-center px-4 justify-between bg-[#0b0f19]">
              <div className="flex items-center gap-1.5">
                <span className="w-3 h-3 rounded-full bg-red-500/60" />
                <span className="w-3 h-3 rounded-full bg-yellow-500/60" />
                <span className="w-3 h-3 rounded-full bg-green-500/60" />
              </div>
              <span className="text-[10px] text-muted-foreground font-mono">mjchatsyncs-enterprise-dashboard</span>
              <div className="w-12" />
            </div>
            ...
            <div className="flex-1 flex overflow-hidden">
              {/* Sidebar */}
              <div className="w-52 shrink-0 border-r border-card/80 bg-[#0b0f19] flex flex-col justify-between py-4 font-sans text-xs">
                {/* Logo & Brand */}
                <div className="px-4 mb-4 flex items-center gap-2">
                  <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-blue-600 text-foreground shadow-[0_0_10px_rgba(37,99,235,0.3)]">
                    <MessageSquare className="h-4 w-4" />
                  </div>
                  <span className="text-sm font-bold tracking-tight text-foreground">MJChatSyncs</span>
                </div>
                  ...
                  {[
                    ...
                    <div
                      ...
                      className={cn(
                        ...
                        item.active
                          ? "bg-blue-600 text-foreground font-medium"
                ...
                {/* Profile Section */}
                <div className="px-3 pt-3 border-t border-card/80 flex items-center gap-2">
                  <div className="h-7 w-7 rounded-full bg-gradient-to-tr from-blue-600 to-emerald-500 flex items-center justify-center text-foreground text-[10px] font-bold shadow-inner">
                    LU
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-[11px] font-semibold text-foreground truncate">lakshit ukani</p>
                    <p className="text-[9px] text-muted-foreground truncate">Workspace Admin</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 bg-[#070a13] flex flex-col overflow-hidden">
                {/* Top Nav */}
                <div className="h-11 border-b border-card/80 bg-[#070a13] flex items-center justify-between px-4">
                  ...
                  <div className="flex items-center gap-3">
                    <Clock className="h-4 w-4 text-muted-foreground hover:text-foreground cursor-pointer" />
                    <div className="h-6 w-6 rounded-full bg-muted border border-border cursor-pointer" />
                  </div>
                </div>
                ...
                <div className="flex-1 p-4 grid grid-cols-12 gap-4 overflow-y-auto custom-scrollbar">
                  ...
                  <div className="col-span-12 lg:col-span-4 bg-[#0d1222]/60 border border-card/80 rounded-xl p-4 flex flex-col justify-between space-y-4">
                    <div className="flex items-center gap-2 text-foreground">
                      <MessageSquare className="h-4 w-4 text-blue-500" />
                      <span className="font-bold text-[13px]">Messages</span>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-[#12182b]/60 border border-card/40 p-3 rounded-lg space-y-1">
                        <span className="text-[10px] text-muted-foreground font-medium">Total Sent</span>
                        ...
                        <span className="text-[8px] text-muted-foreground block">Current Year</span>
                      </div>
                      <div className="bg-[#12182b]/60 border border-card/40 p-3 rounded-lg space-y-1">
                    ...
                    <div className="space-y-2">
                      <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider block">Message Response Analytics</span>
                      <div className="space-y-1.5">
                        {[
                          ...
                          <div key={chan.name} className="flex items-center justify-between text-[11px] py-0.5">
                            <span className="text-foreground font-medium">{chan.name}</span>
                  ...
                  <div className="col-span-12 lg:col-span-5 bg-[#0d1222]/60 border border-card/80 rounded-xl p-4 flex flex-col justify-between">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-bold text-[13px] text-foreground">Message analytics</span>
                      <div className="flex items-center gap-1 text-[10px] text-muted-foreground border border-border bg-[#12182b]/60 px-2.5 py-1 rounded-lg cursor-pointer">
                    ...
                    <div className="flex-1 flex flex-col justify-between min-h-[140px] pt-4">
                      <div className="flex-1 flex items-stretch gap-2.5 relative">
                        {/* Y-Axis */}
                        <div className="flex flex-col justify-between text-[9px] text-muted-foreground w-4 select-none">
                          <span>100</span>
                          <span>75</span>
                          <span>50</span>
                          <span>25</span>
                        ...
                        {/* Bars Area */}
                        <div className="flex-1 border-b border-card/80 relative flex items-end justify-between px-2 pb-1 gap-1">
                          {/* Horizontal Grid lines */}
                          <div className="absolute inset-x-0 top-0 border-t border-card/20" />
                          <div className="absolute inset-x-0 top-1/4 border-t border-card/20" />
                          <div className="absolute inset-x-0 top-2/4 border-t border-card/20" />
                          <div className="absolute inset-x-0 top-3/4 border-t border-card/20" />
                          ...
                          {["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"].map((mon) => (
                            <div key={mon} className="flex-1 flex flex-col items-center gap-1 h-full justify-end">
                              {mon === "Mar" ? (
                                ...
                                <div className="w-full bg-card/20 rounded-t-sm" style={{ height: "2%" }} />
                              )}
                              <span className="text-[8px] text-muted-foreground font-mono scale-90">{mon}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                      {/* Legend */}
                      <div className="flex items-center justify-center gap-4 text-[10px] mt-3 pt-2 border-t border-card/20">
                        <div className="flex items-center gap-1.5">
                  ...
                  <div className="col-span-12 lg:col-span-3 bg-[#0d1222]/60 border border-card/80 rounded-xl p-4 flex flex-col justify-between space-y-4">
                    <div className="flex items-center gap-2 text-foreground">
                      <span className="text-[13px]">👑</span>
                      <span className="font-bold text-[13px]">Your Plan</span>
                    </div>
                    <div className="bg-[#12182b]/80 border border-card/40 p-3 rounded-xl space-y-2 relative overflow-hidden">
                      <div className="absolute top-0 right-0 h-1 bg-gradient-to-r from-blue-500 to-emerald-500 w-full" />
                      <div className="flex items-center justify-between">
                        <span className="text-[11px] font-bold text-foreground">Features</span>
                    ...
                    <div className="space-y-2">
                      <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider block">Feature Breakdown</span>
                      <div className="border border-card/60 rounded-lg overflow-hidden text-[9px]">
                        <div className="grid grid-cols-4 bg-[#0b0f19] px-2.5 py-1.5 text-muted-foreground font-bold border-b border-card/80">
                          <span>Feature</span>
                        ...
                        <div className="divide-y divide-slate-900/40 bg-[#12182b]/20">
                          {[
                            ...
                            <div key={row.name} className="grid grid-cols-4 px-2.5 py-1.5 text-muted-foreground">
                    ...
                    <button className="w-full py-2 bg-blue-600 hover:bg-blue-500 text-foreground text-center font-semibold rounded-lg transition-colors text-[11px] shadow-[0_0_15px_rgba(37,99,235,0.25)] hover:shadow-[0_0_20px_rgba(37,99,235,0.4)]">
                      View Details
                    </button>
                  </div>

                  {/* Bottom Row (All col-span-4) */}
                  <div className="col-span-12 lg:col-span-4 bg-[#0d1222]/40 border border-card/60 rounded-xl p-3 flex items-center justify-between">
                    <span className="font-bold text-[11px] text-foreground">Contact Source Distribution</span>
                    <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground border border-card bg-[#12182b]/40 px-2 py-0.5 rounded-md">
                      <span>All</span>
                      <ChevronDown className="h-2.5 w-2.5" />
                    </div>
                  </div>
                  <div className="col-span-12 lg:col-span-4 bg-[#0d1222]/40 border border-card/60 rounded-xl p-3 flex flex-col justify-center">
                    <span className="font-bold text-[11px] text-foreground">Lead Analytics</span>
                    <span className="text-[9px] text-muted-foreground mt-0.5">Check effectiveness of your ads</span>
                  </div>
                  <div className="col-span-12 lg:col-span-4 bg-[#0d1222]/40 border border-card/60 rounded-xl p-3 flex items-center justify-between">
                    <span className="font-bold text-[11px] text-foreground">Leads</span>
                    <span className="text-[10px] text-muted-foreground font-mono">Real-time Feed</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-5 text-left">
              ...
              <h4 className="text-2xl sm:text-3xl font-bold text-foreground">The Ultimate Shared Team Inbox</h4>
            ...
            {/* Inbox Mockup */}
            <div className="rounded-2xl border border-card bg-background p-4 shadow-xl aspect-[4/3] flex flex-col justify-between overflow-hidden">
              <div className="flex items-center gap-2 border-b border-card pb-3">
                <div className="w-2.5 h-2.5 rounded-full bg-emerald-500" />
                <span className="text-xs font-semibold text-foreground">Active Conversations</span>
              </div>
              <div className="flex-1 grid grid-cols-3 gap-4 pt-3 overflow-hidden">
                {/* Chat List */}
                <div className="border-r border-card/80 pr-2 space-y-2 text-left">
                  {[
                    ...
                    <div key={idx} className={cn("p-2 rounded-lg text-xs space-y-0.5 cursor-pointer", chat.active ? "bg-blue-600/10 border border-blue-500/20" : "bg-card/20")}>
                      <div className="flex justify-between items-center">
                        <span className="font-bold text-foreground">{chat.name}</span>
                ...
                <div className="col-span-2 flex flex-col justify-between h-full text-left">
                  <div className="space-y-3">
                    <div className="bg-card/70 p-2.5 rounded-xl border border-card text-[11px] text-muted-foreground max-w-[90%]">
                      Hello! I want to integrate the WhatsApp API with my Shopify store. Can you share the pricing?
                    </div>
                    <div className="bg-blue-600/10 p-2.5 rounded-xl border border-blue-500/10 text-[11px] text-foreground max-w-[90%] ml-auto text-right">
                      Sure! Our setup is flat ₹2,999/month. Would you like to schedule a quick onboarding call?
                    </div>
                  </div>
                  {/* Quick Replies bar */}
                  <div className="border-t border-card pt-3 flex gap-1">
                    <button className="text-[9px] bg-card border border-border text-muted-foreground px-2 py-1 rounded-md">Send Pricing PDF 📄</button>
                    <button className="text-[9px] bg-card border border-border text-muted-foreground px-2 py-1 rounded-md">Book Onboarding 📅</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
            <div className="space-y-5 text-left md:order-2">
              ...
              <h4 className="text-2xl sm:text-3xl font-bold text-foreground">Real-Time Campaign Analytics</h4>
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            ...
            {/* Analytics Mockup */}
            <div className="rounded-2xl border border-card bg-background p-6 shadow-xl aspect-[4/3] flex flex-col justify-between text-left md:order-1">
              <div className="space-y-2">
                <span className="text-[10px] text-muted-foreground uppercase tracking-widest block font-semibold">Active Campaign</span>
                <h5 className="text-base font-bold text-foreground">Festival Offer Broadcast</h5>
              </div>
              {/* Campaign Stats */}
              <div className="grid grid-cols-4 gap-2 pt-2">
                {[
                  ...
                  <div key={i} className="border border-card bg-card/20 p-2.5 rounded-xl text-center">
              ...
              <div className="flex-1 flex items-center justify-between pt-4">
                <div className="space-y-2 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">Delivered & Read (8,450)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-blue-500" />
                    <span className="text-muted-foreground">Delivered & Unread (1,470)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-red-500" />
                    <span className="text-muted-foreground">Failed (80)</span>
                  </div>
                </div>
                ...
                <div className="relative h-20 w-20 flex items-center justify-center shrink-0">
                  ...
                  <span className="absolute text-xs font-bold text-foreground">84.5%</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-5 text-left">
              ...
              <h4 className="text-2xl sm:text-3xl font-bold text-foreground">No-Code Automated Drip Campaigns</h4>
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            ...
            {/* Drip Mockup */}
            <div className="rounded-2xl border border-card bg-background p-6 shadow-xl aspect-[4/3] flex flex-col justify-between text-left">
              <div className="flex items-center justify-between border-b border-card pb-3">
                <span className="text-xs font-bold text-foreground">Customer Drip Sequence</span>
              ...
              <div className="flex-1 flex flex-col justify-between pt-4 relative">
                {/* Vertical Line */}
                <div className="absolute top-4 bottom-4 left-6 w-0.5 bg-card" />
                {[
                  ...
                  <div key={idx} className="flex gap-4 items-start pl-3 relative z-10">
                    ...
                    <div className="space-y-0.5 text-xs">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] text-muted-foreground font-mono bg-card px-1.5 py-0.5 rounded border border-border">{step.delay}</span>
                      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
            <div className="space-y-5 text-left md:order-2">
              ...
              <h4 className="text-2xl sm:text-3xl font-bold text-foreground">Enterprise-Grade Chatbot Builder</h4>
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            ...
            {/* Flow Builder Mockup */}
            <div className="rounded-2xl border border-card bg-background p-6 shadow-xl aspect-[4/3] flex flex-col justify-between text-left md:order-1 overflow-hidden relative">
              {/* Dot Grid Background */}
              <div className="absolute inset-0 opacity-[0.03] bg-[radial-gradient(#ffffff_1px,transparent_1px)] [background-size:16px_16px]" />
              
              <div className="flex items-center justify-between border-b border-card pb-3 relative z-10">
                <span className="text-xs font-bold text-foreground">Flow: Lead Capture Bot</span>
                <span className="text-[10px] text-muted-foreground font-mono">v1.2 Draft</span>
              </div>
              ...
              <div className="flex-1 flex flex-col items-center justify-center gap-6 py-4 relative z-10">
                ...
                <div className="border border-blue-500/30 bg-blue-950/25 p-3 rounded-xl w-48 text-center space-y-1">
                  ...
                  <p className="text-xs font-bold text-foreground">Keyword: 'START'</p>
                </div>
                {/* Connector Line */}
                <div className="w-0.5 h-6 bg-muted relative">
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-blue-500" />
                </div>
                {/* Message Node */}
                <div className="border border-border bg-card/60 p-3 rounded-xl w-56 text-center space-y-1 relative">
                  <span className="text-[9px] text-purple-400 uppercase font-semibold">Send Message</span>
                  <p className="text-xs font-semibold text-foreground">Welcome Menu Template</p>
                  <div className="flex gap-1 justify-center pt-1.5">
                    <span className="text-[9px] bg-background border border-border text-muted-foreground px-1.5 py-0.5 rounded">Option A</span>
                    <span className="text-[9px] bg-background border border-border text-muted-foreground px-1.5 py-0.5 rounded">Option B</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-5 text-left">
              ...
              <h4 className="text-2xl sm:text-3xl font-bold text-foreground">Train AI on Your Own Knowledge Base</h4>
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            ...
            <div className="rounded-2xl border border-card bg-background p-6 shadow-xl aspect-[4/3] flex flex-col justify-between text-left">
              <div className="flex items-center justify-between border-b border-card pb-3">
                <span className="text-xs font-bold text-foreground">AI Training Center</span>
              ...
              <div className="flex-1 pt-4 space-y-3.5">
                {[
                  ...
                  <div key={i} className="border border-card bg-card/15 p-3 rounded-xl space-y-2">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
            <div className="space-y-5 text-left md:order-2">
              ...
              <h4 className="text-2xl sm:text-3xl font-bold text-foreground">No-Code Integrations & Webhooks</h4>
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
            ...
            <div className="rounded-2xl border border-card bg-background p-6 shadow-xl aspect-[4/3] flex flex-col justify-between text-left md:order-1">
              <div className="flex items-center justify-between border-b border-card pb-3">
                <span className="text-xs font-bold text-foreground">Connected Platforms</span>
                <span className="text-[10px] text-muted-foreground">3 Apps Live</span>
              </div>
              {/* Apps Grid */}
              <div className="flex-1 grid grid-cols-2 gap-4 pt-4">
                {[
                  ...
                  <div key={i} className="border border-card bg-card/10 p-3 rounded-xl flex flex-col justify-between h-20">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-foreground">{app.name}</span>
                      {/* Custom Toggle Switch */}
                      <span className={cn("w-7 h-4 rounded-full p-0.5 transition-colors cursor-pointer", app.status ? "bg-blue-600" : "bg-muted")}>
      ...
      {/* ==========================================
         ...
         ========================================== */}
      <section className="bg-card/10 border-y border-card py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {CAPABILITIES.map((item, idx) => (
              <div key={idx} className="flex gap-4 p-5 rounded-2xl border border-card bg-muted/50 hover:border-border transition-colors group">
                <div className="shrink-0 p-2.5 h-10 w-10 rounded-xl bg-card border border-border flex items-center justify-center group-hover:scale-105 transition-transform">
      ...
      <section id="how-it-works" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-card -translate-y-1/2 hidden md:block -z-10" />

          {HOW_IT_WORKS.map((step, idx) => (
            <div key={idx} className="rounded-2xl border border-card bg-background p-8 space-y-4 relative text-left">
              <span className="absolute -top-6 left-6 text-xs font-extrabold text-blue-500 bg-background border border-card px-3.5 py-2 rounded-full">
                {step.step}
              </span>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-5 space-y-6 text-left">
            ...
            <div className="pt-2">
              <Link
                href="/book-demo"
                className="inline-flex items-center gap-2 font-semibold text-foreground bg-blue-600 hover:bg-blue-500 px-6 py-3 rounded-xl shadow-md transition-all text-sm"
              >
                Get Started
          ...
          <div className="md:col-span-7 grid sm:grid-cols-2 gap-6">
            {WABA_CARDS.map((card, idx) => (
              <div key={idx} className="border border-card bg-background p-6 rounded-2xl space-y-3 text-left hover:border-border transition-colors">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
          {STATS.map((stat, idx) => (
            <div key={idx} className="border border-card bg-card/10 p-6 rounded-2xl backdrop-blur-sm">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((t, idx) => (
            <div
              key={idx}
              className="border border-card bg-card/10 p-6 rounded-2xl flex flex-col justify-between text-left hover:border-border transition-colors"
            >
      ...
      {/* ==========================================
         ...
         ========================================== */}
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-card bg-gradient-to-r from-background via-card/40 to-slate-950 p-12 text-center relative overflow-hidden group">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/pricing"
              className="w-full sm:w-auto text-center font-semibold text-foreground bg-blue-600 hover:bg-blue-500 px-8 py-3.5 rounded-xl shadow-[0_0_20px_rgba(37,99,235,0.3)] transition-all"
            >
              Get Started
            </Link>
            <Link
              href="/book-demo"
              className="w-full sm:w-auto text-center font-medium text-foreground hover:text-foreground px-8 py-3.5 rounded-xl border border-border hover:border-border hover:bg-card/60 transition-all"
            >
              Book a Strategy Call
            </Link>
          </div>
