...
export default function DocumentationPage() {
  return (
    <div className="max-w-6xl mx-auto space-y-10 pb-10">
      <div className="text-center space-y-4 py-12 bg-card/70 rounded-3xl border border-border">
        ...
        <div className="max-w-md mx-auto pt-4 relative px-4">
          ...
          <Input 
            ...
            className="pl-12 py-6 rounded-full bg-background border-border focus-visible:ring-primary/50 text-base"
          />
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {DOCS_CATEGORIES.map((category) => (
          <Card key={category.title} className="border-border bg-card/70 hover:border-border transition-colors">
                ...
                <div className="space-y-4 w-full">
                  ...
                  <ul className="space-y-3">
                    {category.articles.map((article) => (
                      <li key={article}>
                        <a href="#" className="text-sm text-foreground hover:text-primary flex items-center justify-between group">
                          {article}
