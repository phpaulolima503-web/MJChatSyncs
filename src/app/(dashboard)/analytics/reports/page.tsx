...
export default function ReportsAndAlertsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Reports & Alert Engine</h1>
        <p className="text-muted-foreground text-sm">Generate corporate reports, configure alerts, and set up system anomaly thresholds.</p>
      </div>
        ...
        <div className="rounded-xl border border-border bg-card/70 p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Report Interval</label>
              <select
                value={reportType}
                onChange={(e) => setReportType(e.target.value)}
                className="w-full bg-background border border-border rounded-lg p-2.5 text-sm text-foreground focus:outline-none focus:border-amber-500"
              >
            ...
            {/* Export Format */}
            <div className="space-y-2">
              <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Export Format</label>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-background border border-border rounded-lg p-2 text-sm text-foreground focus:outline-none focus:border-amber-500"
              />
            </div>
            ...
            <Button
              ...
              className="w-full bg-muted hover:bg-muted text-foreground border border-border font-semibold"
            >
              Save Alert Rules
            </Button>
          </div>
