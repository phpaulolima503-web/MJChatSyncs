  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Customer lifecycle, retention rate, and engagement metrics</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="rounded-xl border border-border bg-card p-4">
          <h3 className="mb-4 text-sm font-semibold text-foreground">By Industry</h3>
          <div className="space-y-2">
            {data.by_industry.map(i => (
              <div key={i.industry} className="flex justify-between text-xs">
                ...
                <span className="text-foreground font-medium">{i.count}</span>
              </div>
            ))}
          </div>
        </div>
        <div className="rounded-xl border border-border bg-card p-4">
          <h3 className="mb-4 text-sm font-semibold text-foreground">By Country</h3>
          <div className="space-y-2">
