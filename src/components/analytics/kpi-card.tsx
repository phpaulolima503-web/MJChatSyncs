...
export function KpiCard({ label, value, subValue, trend, trendLabel, icon, color = 'blue', size = 'md', loading }: KpiCardProps) {
  ...
  return (
    <div className={cn(
      ...
      {icon && (
        <div className="mb-3 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-card/70">
          {icon}
        </div>
      )}
      ...
      <div className="mt-2 flex items-center justify-between">
        ...
        {trend !== undefined && (
          <div className={cn(
            ...
            trendUp ? "text-emerald-400" : trendDown ? "text-red-400" : "text-muted-foreground",
          )}>
