        ...
        {loading || !contact ? (
          ...
          <div className="flex flex-col h-full">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <Link href={`/contacts/${contact.id}`}>
                      <Button
                        variant="outline"
                        size="sm"
                        className="text-xs h-7 border-border hover:bg-muted hover:text-foreground text-foreground shrink-0"
                      >
                        Open Full Profile
                      </Button>
                    </Link>
            ...
            <Tabs defaultValue="details" className="flex-1 flex flex-col min-h-0">
              <TabsList className="bg-accent/60 border-b border-border mx-4 mt-3">
                <TabsTrigger
                  value="details"
                ...
                <div className="flex-1 overflow-y-auto space-y-2">
                  {loadingNotes ? (
                    ...
                    notes.map((note) => (
                      <div
                        key={note.id}
                        className="rounded-lg bg-accent/60 border border-border/50 p-3 group"
                      >
                ...
                {loadingDeals ? (
                  ...
                  <div className="space-y-2">
                    {deals.map((deal) => (
                      <div
                        key={deal.id}
                        className="rounded-lg border border-border bg-accent/60 p-3"
                      >
                        <div className="flex items-start justify-between gap-2">
